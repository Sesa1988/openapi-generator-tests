...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubmodelValue : IEquatable<SubmodelValue>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SubmodelValue)obj);
        }

        /// <summary>
        /// Returns true if SubmodelValue instances are equal
        /// </summary>
        /// <param name="other">Instance of SubmodelValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmodelValue other)
        {
        ...
        public static bool operator ==(SubmodelValue left, SubmodelValue right)
        {
