...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class EventElement : SubmodelElement, IEquatable<EventElement>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EventElement)obj);
        }

        /// <summary>
        /// Returns true if EventElement instances are equal
        /// </summary>
        /// <param name="other">Instance of EventElement to be compared</param>
        /// <returns>Boolean</returns>
