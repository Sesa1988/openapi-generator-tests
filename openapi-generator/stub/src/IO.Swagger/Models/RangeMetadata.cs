...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RangeMetadata : SubmodelElementAttributes, IEquatable<RangeMetadata>, OneOfSubmodelElementMetadata 
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RangeMetadata)obj);
        }

        /// <summary>
        /// Returns true if RangeMetadata instances are equal
        /// </summary>
        /// <param name="other">Instance of RangeMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RangeMetadata other)
        {
        ...
        public static bool operator ==(RangeMetadata left, RangeMetadata right)
        {
