...
namespace IO.Swagger.Models
{
    ...
    { 
        ...
        [DataMember(Name="valueReferencePairs")]
        ...
        public bool Equals(ValueList other)
        {
            ...
            return 
                (
                    ValueReferencePairs == other.ValueReferencePairs ||
                    ValueReferencePairs != null &&
                    ValueReferencePairs.SequenceEqual(other.ValueReferencePairs)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ValueReferencePairs.GetHashCode();
                return hashCode;
            }
        }
