...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpecificAssetIdValue : IEquatable<SpecificAssetIdValue>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpecificAssetIdValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SpecificAssetIdValue)obj);
        }

        /// <summary>
        /// Returns true if SpecificAssetIdValue instances are equal
        /// </summary>
        /// <param name="other">Instance of SpecificAssetIdValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpecificAssetIdValue other)
        {
        ...
        public static bool operator ==(SpecificAssetIdValue left, SpecificAssetIdValue right)
        {
